...
def getCheckpointCallback(cfg, logger=None, **kwargs):
    ...
    metric_monitor = {
        ...
        "gt_R_TOP_3": "Metrics_GT/R_precision_top_3",
        "FID": "Metrics/FID",
        "gt_FID": "Metrics_GT/FID",
    ...
    # Save all checkpoints every epoch
    checkpointParams = {
    ...
    checkpointParams.update({
        'every_n_epochs': 1,  # Check every epoch to save best metric checkpoints
        'save_top_k': 1,
    })
