...
cd /mnt/data8tb/Documents/models/repo/MotionGPT3
...
source /mnt/data8tb/Documents/models/repo/MotionGPT3/.mgpt3/bin/activate
python -u train.py \
    --cfg configs/MoT_vae_stage1_t2m-diffusion.yaml \
